...
const Dashboard = () => {
  return (
    <>
      <section className="bg-gray-900 dark:bg-gray-900 p-3 sm:p-5 antialiased">
        <div className="mx-auto max-w-screen-xl px-4 lg:px-12">
          <div className="bg-gray-800 dark:bg-gray-800 relative shadow-md rounded-lg overflow-hidden">
              ...
              <table className="w-full text-sm text-left text-gray-400 dark:text-gray-400">
                ...
                <tbody>
                  <tr className="border-b border-gray-700">
                    ...
                    <td className="px-4 py-3">Unclaimed</td>
                    <td className="px-4 py-3 max-w-[12rem] truncate">
                      A short description of code where it may used
                    </td>
                    <td className="px-4 py-3">Enabled</td>

                    <td className="px-4 py-3 flex items-center justify-start gap-1 ">
                      <button
                        type="button"
                        id="updateProductModalButton"
                        data-modal-target="updateProductModal"
                        data-modal-toggle="updateProductModal"
                        className="mt-2 sm:mt-0 bg-yellow-500 text-white px-3 py-2 rounded-lg"
                      >
                        Modify
                      </button>
                      ...
                      <button
                        ...
                        className="mt-2 sm:mt-0 bg-red-500 text-white px-3 py-2 rounded-lg"
                      >
                        Delete
                      </button>
                    </td>
